...
-(void)markDateSelected:(NSDate *)date
{
    ...
    NSUserDefaults *defaultsForStoreData=[NSUserDefaults standardUserDefaults];
    [defaultsForStoreData setObject:strDate forKey:@"date"];
    [defaultsForStoreData synchronize];
